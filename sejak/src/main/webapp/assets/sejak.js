...
Sejak = {
						...
						for(var i=0; i<node.children.length; i++){
							...
							switch(c.nodeName.toLowerCase()){
								...
								case 'css':
									...
									Sejak.appendCSS("/* gen-preproc "+pack+"-"+name+"\t*/", Sejak.tk.preProcCSS.parseBlock(child.css));
									break;
								default:
							}
						}
	...
	loadProject : function(){
		$("head").append($("<style id='sjStyleSheet'></style>"));
		Sejak.tk.loadJS(Sejak.basePath + "app.project");
	},
	appendCSS : function(title, str){
		if(Sejak.Project.css == undefined) Sejak.Project.css = '';
		Sejak.Project.css += "\n" + title + "\n" + str;
		$("#sjStyleSheet").text(Sejak.Project.css);
		console.log("appendCSS:", Sejak.Project.css);
	},
	loadPage : function(){
